  ...
  <tbody>
        ...
        $query  = "select * FROM users a, timetable b
              ...
              echo "<tr><td>".$sno."</td>";
					              ...
					              echo '<td><a href="editdetailroutine.php?id='.$row['tid'].'"><input type="button" class="btn btn-info" id="boxxe" value="Edit Routine" ></a></td>';
								 echo "<td><form action='deleteroutine.php' method='post' onsubmit='return ConfirmDelete()'><input type='hidden' name='name' value='" . $row['tid'] . "'/>
                 <input type='submit' value='Delete' width='20px' id='boxxe' class='btn btn-danger'/></form></td></tr>";
